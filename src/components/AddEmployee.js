  ...
  return (
    ...
    <button onClick={handleShow} className="m-2 block mx-auto bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">+ Add Employee</button>
      ...
      >
        ...
        <Modal.Body>
        <form onSubmit={(e)=>{e.preventDefault(); setName(''); setRole(''); setImg(''); props.newEmployee(name, role, img);  console.log("hello from editemployee")}} id="editmodel" class="w-full max-w-sm">
